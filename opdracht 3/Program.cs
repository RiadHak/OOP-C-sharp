    ...
    public static void Main(string[] args)
    {
        ...
        while (game)
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                Console.WriteLine(trainer1.add_poke_ball(new PokeBall(new Charmander(char_name, "fire", "water","Charmander"))));
                Console.WriteLine(trainer2.add_poke_ball(new PokeBall(new Charmander(char_name, "fire", "water","Charmander"))));
            }
